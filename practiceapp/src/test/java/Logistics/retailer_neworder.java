...
public class retailer_neworder {
	...
	public static void main(String[] args) throws Throwable {
		...
		driver.get(URL);
		driver.findElement(By.name("txtUsername")).sendKeys(RETAILER_USERNAME);
		driver.findElement(By.name("txtPassword")).sendKeys(RETAILER_PASSWORD);
		//login
	...
	ele.click();
		...
		driver.findElement(By.id("1")).sendKeys("25");
		//driver.findElement(By.xpath("//table/tbody/tr[3]/td[5]")).sendKeys("15");
