...
public class manageunit_manufacturer {
	...
	ele.click();
		...
		//driver.findElement(By.xpath("//table/tbody/tr[7]/td[4]")).clear();
		
		//driver.findElement(By.xpath("//table/tbody/tr[7]/td[4]")).sendKeys("25");
		driver.findElement(By.name("txtQuantity[32]")).clear();
		driver.findElement(By.name("txtQuantity[32]")).sendKeys("25");
